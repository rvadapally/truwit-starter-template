...
const viewport = {name: "desktop", width: 1920, height: 1080};

(async () => {
    console.log(`📸 Starting DESKTOP screenshot capture from: ${baseUrl}`);
    ...
    for (const page of pages) {
        ...
        try {
            ...
            const fullScreenshot = `${outputDir}/${page.name}-desktop-full.png`;
            ...
            const viewportScreenshot = `${outputDir}/${page.name}-desktop-viewport.png`;
            await pageInstance.screenshot({ 
                path: viewportScreenshot, 
                fullPage: false 
            });
            
            console.log(`  ✅ Full + Viewport`);
            successCount += 2;
    ...
    console.log('');
    console.log('================================');
    console.log('Desktop Screenshot Summary');
    console.log('================================');
